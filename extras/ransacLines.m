function [ lines ] = ransacLines( laserScanCartesian, parameters )
...
%% Parameters
maxNoOfLines = parameters(1); % The maximum number of line extraction iterations
noOfRandomCouples = parameters(2); % The number of random point couples to try before choosing the best candidate
distThreshold= parameters(3); % The distance threshold determining whether a point is supporting a line
minLineSupport= parameters(4); % The minimum number of points to support a line for the line to be accepted
minNoOfPoints= parameters(5); % The minimum number of points to continue line extraction iterations
